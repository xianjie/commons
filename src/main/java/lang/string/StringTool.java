...
import collections.MapTool;
import log.Log;
import log.LogFactory;
import org.apache.commons.lang3.ObjectUtils;
import security.CryptoTool;
import security.DigestTool;
...
public class StringTool {
     ...
     * </pre>
     *
     * @param strings 待处理的字符串数组，可以为null
     * @return 处理后的字符串数组，{@code null} 如果strs参数值为null
     */
    public static String[] stripAll(String... strings) {
        return org.apache.commons.lang3.StringUtils.stripAll(strings);
    }
    ...
    public static String[] stripAll(String[] strings, String stripChars) {
        return org.apache.commons.lang3.StringUtils.stripAll(strings, stripChars);
    }
     ...
     *
     * @param str           待查找的字符序列，可以为null
     * @param searchStrings 要查找的字符串组, 可以为null
     * @return 任何第一次匹配的字符串的下标。如果没有找到或cs为null、searchChars为null或空数组，将返回-1。
     * searchStrings，将返回0
     */
    public static int indexOfAny(CharSequence str, CharSequence... searchStrings) {
        return org.apache.commons.lang3.StringUtils.indexOfAny(str, searchStrings);
    }
    ...
    public static int lastIndexOfAny(CharSequence str, CharSequence... searchStrings) {
        return org.apache.commons.lang3.StringUtils.lastIndexOfAny(str, searchStrings);
    }
     ...
     * <p>
     * 规则:
     * 如果 {@code str} 的长度 比 {@code maxWidth} 还小, return {@code str}
     * 否则省略为： {@code (substring(str, 0, max-3) + "...")}
     * 如果 {@code maxWidth} 比 {@code 4} 小, 抛出 {@code IllegalArgumentException} 异常.
     * 永远不会返回长度超过 {@code maxWidth} 的字符串.
     * <pre>
     ...
     * </pre>
     *
     * @param strings 字符串数组，可以为null，为null或元素都为null或没有相同前缀时返回空串，
     * @return 相同的前缀
     */
    public static String getCommonPrefix(String... strings) {
        return org.apache.commons.lang3.StringUtils.getCommonPrefix(strings);
    }
