...
public class TypeTool {
     ...
     * 在一些情况下, <code>toClass</code>指定的接口(间接)被实现不只一次(如: <code>toClass</code>指定为{@link Iterable Iterable}
     * 接口, <code>type</code>指定一个实现{@link Set Set}和{@link java.util.Collection Collection}的参数化类型)<br>
     ...
     * {@link java.util.Collection}的参数, {@link Iterable}的参数.因为<code>TreeSet</code>的参数映射为<br>
